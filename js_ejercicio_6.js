// Seleccionamos el campo del marcador de tiemppo, los 3 botones y el checkBox
const tiempo = document.getElementById("tiempo");
const botonIniciar = document.getElementById("iniciar");
const botonPausar = document.getElementById("pausar");
const botonReiniciar = document.getElementById("reiniciar");
const checkBox = document.getElementById("conParada");
...
class Timer{
    ...
    constructor(elemento=tiempo,horas=0,minutos=0,segundos=0){
        this.#hrs=horas;
        this.#min=minutos;
        this.#seg=segundos;
        this.#elem=elemento;
    ...
    actualizaTiempo(){
        ...
        let nuevoTiempo = Timer.tiempoString(this.#hrs, this.#min, this.#seg);
...
// Creamos una instancia de Timer
...
botonReiniciar.addEventListener("click",()=>{
    temporizador.reiniciar(checkBox.checked);
});